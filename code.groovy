/**
 * ThingInfo to SpringXD Endpoint
 * Author: Scott Kahler
 *
 * Based on: 
...
definition(
    name: "Things to SpringXD",
    namespace: "Things2SpringXD",
    author: "Scott Kahler",
    description: "Collect data from all the things",
    category: "My Apps",
...
private logField(evt, Closure c) {
    ...
    httpPostJson(uri: "http://your.uri.spot:9000/",   body:[device: evt.deviceId, name: evt.name, value: evt.value, date: evt.isoDate, unit: evt.unit]) {
        log.debug evt.name+" Event has been data successfully posted"
    }
}
